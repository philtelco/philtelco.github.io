...
{% raw %}<p><center><a href="/assets/img/woz_blue_box.jpg"><img style="width: 80%; max-width: 300px; display: block; margin: 0 auto; border 0" src="/assets/img/woz_blue_box.jpg"></a><figquote>This blue box was created by Steve Wozniak before he went on to co-found Apple Computer. Photo by Maksym Kozlenko.</figquote></center></p>{% endraw %}  
